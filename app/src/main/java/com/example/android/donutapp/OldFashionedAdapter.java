...
public class OldFashionedAdapter extends RecyclerView.Adapter<OldFashionedAdapter.ViewHolder> {
    ...
    public OldFashionedAdapter(ArrayList<DonutsDao> searchDataSet, int itemLayout) {
        this.mDataSet = searchDataSet;
        this.itemLayout = itemLayout;
    }

    public OldFashionedAdapter(ArrayList<DonutsDao> searchDataSet) {
        mDataSet = searchDataSet;
    }

    public OldFashionedAdapter(ArrayList<DonutsDao> searchDataSet, Context context, int itemLayout) {
        this.mDataSet = searchDataSet;
